...
local function tree_burnt(inst)
    local burnt_tree = SpawnPrefab("hybrid_banana_cooked")
...
local function burnt_fn()
    ...
    inst:SetPrefabNameOverride("hybrid_banana_tree")
...
return Prefab("hybrid_banana_tree", tree_fn, assets, prefabs_tree),
