--Created: Luka 
return {
	ANNOUNCE_HATEFOOD = "에우우!",
	ANNOUNCE_ADVENTUREFAIL = "뮤샤의 팔이 더 이상 올라가질 않아..",
	ANNOUNCE_BOOMERANG = "뮤샤를 때리지마 나쁜 나무야!",
	ANNOUNCE_CHARLIE = "뮤샤 뒤에 뭔가 있어!",
	ANNOUNCE_CHARLIE_ATTACK = "비겁한 녀석, 숨어서 때리지마!",
	ANNOUNCE_COLD = "아! 뮤샤의 손가락이 얼었어!",
	ANNOUNCE_HOT = "뮤샤는 너무 더워!",
	ANNOUNCE_DUSK = "햇살이 갔어. 뮤샤는 빛을 준비해야해!",
	ANNOUNCE_EAT =
      {
                GENERIC = "얌!",
                PAINFUL = "에우우!",
                SPOILED = "이건 음식이 아니야! 으에!",
                STALE = "우웨!",
		YUCKY = "우웨!",
	},
	ANNOUNCE_NOSLEEPONFIRE = "뮤샤는 여기에서 잘수없어! 그림자를 조심해야 해.",
	ANNOUNCE_NODANGERSIESTA = "뮤샤는 이상한 소리를 들었어!",
	ANNOUNCE_NONIGHTSIESTA = "여기서 쉬기에는 너무 추워..",
	ANNOUNCE_NONIGHTSIESTA_CAVE = "여긴 정말 추워!.",
	ANNOUNCE_NOHUNGERSIESTA = "뮤샤는 너무 배고파. 쉬기전에 뭔가 먹어야해!",
	ANNOUNCE_SHELTER = "정말 편안해 보여.",
	ANNOUNCE_BURNT = "이상하게 생긴 까만 나무..",
	ANNOUNCE_TOOL_SLIP = "미끄러!",
	ANNOUNCE_DAMP = "비온다!",
	ANNOUNCE_WET = "축축해..",
	ANNOUNCE_WETTER = "이건 너무 축축해.",
	ANNOUNCE_SOAKED = "전부 젖었어.. 옷갈아입고 싶어!",
	ANNOUNCE_HOUNDS = "들었어? 하운드가 가까이 왔어.",
	--ANNOUNCE_HUNGRY = "Musha needs meats. Anyone?",
	ANNOUNCE_HUNGRY = "너무 배고파..",
	ANNOUNCE_HUNT_BEAST_NEARBY = "뮤샤는 드디어 찾았어! 정말 커!",
	...
	ANNOUNCE_ACCOMPLISHMENT_DONE = "뮤샤는 해냈어!",
	ANNOUNCE_LIGHTFIRE =
	{
		[1] = "빛이야!",
		[2] = "불이야!",
		[3] = "불은 정말 좋아!",
		[4] = "움직여 움직여 붉은 빛아!",
		[5] = "요리는 할 수 없지만 정말 따뜻해!",
		[6] = "예아!",
	},
	ANNOUNCE_PECKED = "나쁜 새!",
	ANNOUNCE_TORCH_OUT = "작은 빛이 어디갔어?",
	ANNOUNCE_WORMHOLE = "뮤샤는 끈적한게 싫어.",
	ANNOUNCE_TRAP_WENT_OFF = "아!",
	ANNOUNCE_CRAFTING_FAIL = "에? 이건 작동하지 않아.",
    ANNOUNCE_QUAKE = "동굴이 배탈났어!",
    ANNOUNCE_NODANGERSLEEP = "뮤샤의 귀가 뭔가 찾았어.\n뮤샤는 이걸 조사 해봐야해.",
    ...
    ANNOUNCE_HIGHRESEARCH = "멋져! 뮤샤가 만들었어.",
    ANNOUNCE_THORNS = "우! 건방진 식물!",
    ANNOUNCE_NODAYSLEEP_CAVE = "뮤샤는 더 놀고 싶어!\n뮤샤는 피곤하지 않아.",
    ANNOUNCE_BEES = "브으우우! 뮤샤의 귀가 아파!",
    ...
    ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "뮤샤는 빛보다 빨라!",
        ...
        COMBAT_QUIT =
        {
                ...
                SPIDER_WARRIOR = "뮤샤는 점프하는 초록거미가 싫어!",
        },
	--우와 정말 귀찮다..
	DESCRIBE =
	{
		...
		MUSHA_EGG_CRACKEDS2 = "Such a big bud, isn't it?",
		...
		MUSHA_TEEN = "Yamche is a very small bird, but a brave bird!\nOrder:(Z,V,B)",
		MUSHA_TEENR1 = "Yamche is a very small bird, but a brave bird!\nOrder:(Z,V,B)",
		MUSHA_TEENR2 = "Yamche is a very small bird, but a brave bird!\nOrder:(Z,V,B)",
		MUSHA_TEENR3 = "Yamche is a very small bird, but a brave bird!\nOrder:(Z,V,B)",
		MUSHA_TEENR4 = "Yamche is a very small bird, but a brave bird!\nOrder:(Z,V,B)",
		MUSHA_TEENICE = "Yamche is a very small bird, but a brave bird!\nOrder:(Z,V,B)",
        ...
        STATUEGLOMMER =
        {
        	GENERIC = "Musha knows that! Um... What was it?",
		...
		CACTUS_FLOWER = "Flower from the head of the cactus. But Musha doesn't eat that.",
		COLDFIRE =
		{
		...
		COONTAIL = "Musha doesn't know why Musha cut that from the cat.",
		COOKPOT =
		{
		...
		ARMORDRAGONFLY = "If someone touches Musha, they would burn.",
		DRAGON_SCALES = "It is cool! Ow, not cool.",
		DRAGONFLYCHEST = "This chest can absorb fire, it can't burn!",
		DECIDUOUSTREE =
		{
			BURNING = "Waaaagh!",
		...
		FARMPLOT =
		{
			GENERIC = "It is land for planting seeds.",
		...
		FIRESUPPRESSOR =
		{
			ON = "It requires a lot fuel. Don't forget to check it.",
			OFF = "If it's summer,\n Musha must put fuel in it.",
			LOWFUEL = "Fuel is running low. Musha checked it.",
		},
		ICEHAT = "Problem is Musha's soles are still hot.",
		LIGHTNINGGOAT =
		{
		...
		MEATRACK =
		{
			...
			DRYINGINRAIN = "It seems to need an umbrella.",
			GENERIC = "Musha can make jerky to using that.\n Jerky is delicious. ",
			BURNT = "Putting cooked meat on the drying rack is fastest way to make jerky.",
		},
		MERMHEAD =
		{
			GENERIC = "Ow. Musha doesn't like him and he doesn't like Musha.",
		...
		GOOSE_FEATHER = "It can use to make a fan but can't be used as a pen.",
		...
		RAINHAT = "Musha likes to drink water, not get water in Musha's hair.",
		RESEARCHLAB =
		{
		...
		RESEARCHLAB4 =
		{
			GENERIC = "Why does it hold a top hat at here? For science?",
		...
		TENT =
		{
			...
			BURNT = "Musha's base has been burned to ashes!.",
		},
		SIESTAHUT =
		{
		...
		TREASURECHEST =
		{
			...
			BURNT = "It's over! ALL OVER! All Musha's items gone!",
		},
		...
		WATERMELON = "It's big, but does give Musha a full belly.",
