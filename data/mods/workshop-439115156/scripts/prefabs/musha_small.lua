...
elseif leader and --[[not cave and]] inst.components.inventoryitem ~= nil and not inst.picked then
inst:RemoveComponent("inventoryitem")
...
inst:DoTaskInTime(1, function()
    ...
    elseif food.components.edible and (food.components.edible.hungervalue >= 140 and food.components.edible.healthvalue >= 90) then
...
if not inst.level1 and inst.components.inventoryitem ~= nil and inst.components.equippable then 
	inst.components.inventoryitem.cangoincontainer = false
	inst.components.inventoryitem:SetOnDroppedFn(Dropped_cave)
	inst.components.inventoryitem:SetOnPutInInventoryFn(OnPutInInventory_cave)
	inst.components.equippable.equipslot = EQUIPSLOTS.HEAD
...
elseif inst.level1 and inst.components.inventoryitem ~= nil and inst.components.equippable then  
